...
contract TeamUpdateRSS is Ownable {
    ...
    function is_addr_whitelisted(uint _ID, address _addr) public view returns (bool){
        require(_ID < TeamIDCount && _ID > 0);
        return team_whitelist[_ID][_addr];
    }
